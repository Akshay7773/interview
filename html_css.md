...
| ex | Relative to the x-height of the current font (rarely used) | [Try it](tryit.php?filename=trycss_unit_ex) |
...
* **Use Case:** Good for **component-level scaling**, like padding or spacing inside a container.
* **Example:**
...
* **Use Case:** Good for **consistent sizing across the entire page**.
* **Example:**

```css
h1 { font-size: 3rem; } /* 3 times the root font size */
```
...
* **Definition:** Relative to **the parent element’s size** (width, height, or font-size depending on context).
* **Use Case:** Fluid layouts and responsive designs.
* **Example:**

```css
div { width: 50%; } /* half the parent’s width */
```
...
* **Use Case:** Full-height sections, hero banners.
* **Example:**

```css
section { height: 100vh; } /* full screen height */
```
...
* **Use Case:** Responsive typography or elements based on screen width.
* **Example:**

```css
h1 { font-size: 10vw; } /* scales with viewport width */
```
...
* **`%`** → relative to parent (size or width/height)
